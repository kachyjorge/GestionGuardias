 ...
 * InformeC.java
 *
 * Created on 03-oct-2011, 18:24:12
 */
package menu;
 ...
 * @author admin
 */
public class InformeC extends javax.swing.JFrame {

    /** Creates new form InformeC */
    public InformeC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Generar Practica de Cirugias");
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    if (fechaMes >= 6 & fechaMes1 <= 12){
                    ...
                    InformeCirugia icc = new InformeCirugia();
                    icc.setVisible(true);
    }
    else{
...
private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformeC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
